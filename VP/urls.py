...
urlpatterns = [
    ...
    path("registrations/<int:registration_id>/ticket/", views.download_ticket_pdf, name="download_ticket_pdf"),
    ...
    path("submit-event-proposal/", views.submit_event_proposal, name="submit_event_proposal"),
